class LaptopStarter{
	...
	public static void main(String[] lap){
		...
		cities1.name="Goa";
		cities1.stateName="Panaji";
		
		City cities2=new City();
		cities2.name="Ahmedabad";
		cities2.stateName="Gujurat";
		...
		cities4.name="Pune";
		cities4.stateName="Maharastra";
		
		City cities5=new City();
		cities5.name="Bhopal";
		cities5.stateName="MadhyaPradesh";
		...
		hardware9.setName("data storage");
